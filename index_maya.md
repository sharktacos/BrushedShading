...
To help get you started, an example Maya project is included featuring the wonderful <a href="https://leorezende.gumroad.com/l/FeiFei" target="_blank">FeiFei model by Leo Rezende</a>. This is a production ready shot lighting scene, including camera, lights, animation cache, hand painted texture maps, and of course, Brushed Shading material node networks for the character's eyes, hair, skin, and clothing. See the video tutorials link above for a scene walk-through.
